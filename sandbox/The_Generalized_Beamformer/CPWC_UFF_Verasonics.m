...
plot(channel_data.N_elements,[channel_data.sequence(selected_tx).delay_values(end)+abs(min(channel_data.sequence(selected_tx).delay_values))]*10^6,'o','DisplayName','Conventional t_0','LineWidth',2)
...
title(["Single Plane Wave Image"]);
set(gcf,'Position',[605 197 484 781])
set(gca,'FontSize',15)
%%
f = gcf;
saveas(f,'Figures/PW.png');